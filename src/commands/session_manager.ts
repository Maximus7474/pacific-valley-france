import { ButtonBuilder, ButtonStyle, ChatInputCommandInteraction, ContainerBuilder, MessageFlags, SeparatorBuilder, SeparatorSpacingSize, SlashCommandBuilder, StringSelectMenuBuilder, StringSelectMenuInteraction, StringSelectMenuOptionBuilder, TextDisplayBuilder } from "discord.js";
...
export default new SlashCommand({
    ...
    callback: async (logger, client, interaction) => {
        ...
        if (group === 'create' && subCommand === 'create') {
            CreateSession(logger, interaction);
            return;
        }
    }
});